...
parser.add_argument("--run_name", type=str, default="BlitzNet300_COCO+VOC07+12", required=False)
...
parser.add_argument("--dataset", default='voc12-train', choices=['voc07', 'voc12-train', 'voc12-val',
...
parser.add_argument("--x4", default=True, action='store_true')
...
parser.add_argument("--lr_decay", default=[40000, 50000], nargs='+', type=int)

# Random initialization of a base network
parser.add_argument("--random_trunk_init", default=True, action='store_true')  # False
...
parser.add_argument("--segment", default=True, action='store_true')
...
parser.add_argument("--eval_min_conf", default=0.5, type=float)
